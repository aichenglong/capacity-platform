...
public class MpGenerator {
  ...
  public static void main(String[] args) {
    ...
    dsc.setUrl("jdbc:mysql://118.24.16.110:3306/test?characterEncoding=utf8");
    ...
    // strategy.setTablePrefix(new String[] { "tlog_", "tsys_" });// 此处可以修改为您的表前缀
     ...
     strategy.setInclude(new String[] { "sys_user","sys_role","sys_user_role","sys_role_menu","sys_menu" }); // 需要生成的表
    ...
    pc.setParent("com.capacity.platform");
