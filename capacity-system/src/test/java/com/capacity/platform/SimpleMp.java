...
public class SimpleMp { 
  ...
  public void generateCode() { 
    //指定包名 
    String packageName = "com.capacity.platform.system";
    //user -> UserService, 设置成true: user -> IUserService 
    boolean serviceNameStartWithI = false; 
    //指定生成的表名 
    String[] tableNames = new String[]{"sys_user", "sys_role", "sys_menu","sys_user_role","sys_role_menu"};
  ...
  private GlobalConfig getGlobalConfig(boolean serviceNameStartWithI) { 
    ...
    globalConfig 
        ...
        .setAuthor(System.getProperty("os.name"))
        //设置输出路径 
  ...
  private String getOutputDir(String projectName) { 
    ...
    return   "/home/icl/IdeaProjects/capacity-platform/capacity-system/src/main/java/";
  } 
  /** 
   * 策略配置 
   * 
  ...
  private DataSourceConfig getDataSourceConfig() { 
    String dbUrl = "jdbc:mysql://118.24.16.110:3306/test";
